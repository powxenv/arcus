...
**Honesty note 1: A1/A2 are content-sampling bins, not validated facets (v0.22 reframe).** Campbell et al. (1996) report that the SCC Scale has one major factor. The split into A1 (Self-Knowledge) and A2 (Self-Consistency) is **not** a validated two-factor decomposition. It is a content-sampling split retained so the facet-tension detector has two sub-scores to compare for cancellation. A1 samples the *contents* of self-knowledge (attributes, values, preferences); A2 samples the *stability* of that knowledge across time and context. Both draw from the same unidimensional construct. If pilot data ever shows them converging to one factor, the separate reporting is harmless because it was never claiming two factors.
...
**Honesty note 2: B1/B2 are content-sampling bins, not validated facets (v0.22 reframe).** Kernis and Goldman (2006) propose four interrelated components; Wood et al. (2008) find three factors. The pairing into B1 (Awareness + Behavior content) and B2 (Relational Authenticity content) covers three of Kernis & Goldman's four components. The Unbiased Processing component, the ability to objectively evaluate oneself without denying, distorting, or exaggerating self-relevant information, is not directly measured by B1 or B2. Unbiased processing is the hardest component to self-report: people who are good at self-deception cannot accurately report on their self-deception. Kernis & Goldman's own Unbiased Processing subscale has the lowest internal consistency (α = .64) of the four. We note the gap rather than pretend it is covered. Like A1/A2, the B1/B2 split is a content-sampling choice retained for facet-tension detection, not a validated decomposition.
